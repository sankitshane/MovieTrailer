...
death_note = anime.Anime("Death Note",
...
code_geass = anime.Anime("Code Geass",
...
sword_art = anime.Anime("Sword Art Online",
...
shokugeki = anime.Anime("shokugeki no soma",
...
Pokemon   = anime.Anime("Pokemon",
                        "Action,Fantasy,Adventure",
                        "http://img09.deviantart.net/b8a7/i/2015/108/5/3/pokemon_poster_by_viking011-d77ur7y.jpg", #noqa
                        "https://www.youtube.com/watch?v=NTJHbpjLpjA")

#Putting all anime instances in a array called anime_array
anime_array = [naruto, death_note, code_geass, sword_art, shokugeki, Pokemon]

#calling open_movies_page function in fresh_tomatoes.py with the array argument
